      ...
      <Paper sx={{ p: 3, my: 2 }}>
        ...
        <Box sx={{ mt: 2 }}>
          <Typography variant="caption" color="text.secondary">
            Nota: Este componente é apenas para demonstração. Em um ambiente real, os dados
            originais nunca devem ser exibidos ou armazenados sem a devida proteção.
          </Typography>
        </Box>
      </Paper>
      {/* Componente de demonstração do Refresh Token */} <RefreshTokenDemo />
    </Box>
  );
};
